package com.yetsdmr.classesandfunctions
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var homer = Simpson("Homer Simpson", 50, "Nuclear")
        ...
        //Nullability
        // Nullable (?) && Non-null
        // !! (Vallaha bu değer nuul gelmeyecek biliyorum, eminim) vs ? (değer null gelebilir bil kısma )
        ...
        //3)elvis
        val myResult = myAge?.compareTo(2) ?: -100   //(?:-100  --> eğer sonuç doğru değilse değer -100 olsun diyoruz)
        println(myResult)
    }
